...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<ExceptionResponse> handleGastoNotFoundException(final GastoNotFoundException ex,
	...
	public final ResponseEntity<ExceptionResponse> handleCategoriaNotFoundException(final CategoriaNotFoundException ex,
			final WebRequest request) {
		final ExceptionResponse exceptionResponse = new ExceptionResponse(NOT_FOUND, LocalDateTime.now(),
				ex.getMessage(), request.getDescription(false));
		return new ResponseEntity<>(exceptionResponse, HttpStatus.NOT_FOUND);
